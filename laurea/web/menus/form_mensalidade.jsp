    ...
    <body>
        <div class="container">
            ...
            <form action="gerenciar_mensalidade.do" method="POST">
                ...
                <input type="hidden" name="idmensalidade" id="idmensalidade" value="${mensalidade.idmensalidade}"/>
                <div class="row">
                    <div class="form-group col-sm-8">
                        <label for="nome"> Nome </label>
                        <input type="text" class="form-control" id="nome" name="nome" required="" maxlength="45" value="${mensalidade.nome}"/>
                    </div>    
                </div>
                ...
                <div class="row">
                    ...
                    <a href="../listar/listar_mensalidade.jsp" class="btn btn-warning">Voltar</a>    
                </div>     
            </form>    
        </div>
    </body>
